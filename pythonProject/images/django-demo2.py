...
def main():
    ...
    # 用火狐浏览器打开网页
#    driver.get("http://172.28.1.15:8000/")
    ...
    #b站 鼠标悬浮动作
    gtSildeButton = driver.find_element_by_xpath("//div[@class='gt_slider_knob gt_show']")
    ActionChains(driver).move_to_element(gtSildeButton).perform()
